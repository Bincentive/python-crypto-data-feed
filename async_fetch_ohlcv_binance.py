...
currency_type = ['ADA/USDT','BCH/USDT','BNB/USDT','BTC/USDT','EOS/USDT','ETC/USDT','ETH/USDT','IOTA/USDT','LTC/USDT','NEO/USDT','TRX/USDT','XLM/USDT','XRP/USDT']
currency = currency_type*5
exchange_name = ['binance']*len(currency)
